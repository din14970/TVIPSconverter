...
class Recorder(object):
    ...
    def __init__(self, filename, filterfunc=None, numframes=None, framerecord=None):
        ...
        try:
            ...
            else: #read only the first self.numframes from the first data
    ...
    def _readGeneral(self, fh):
        ...
        self.dtype = np.uint8 if self.general.bitsperpixel == 8 else np.int16
...
def main(opts):
    ...
    def filterfunc(x): #x is the frame
    ...
    elif (opts.otype == str(OutputTypes.Blockfile)):
